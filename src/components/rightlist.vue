...
<template>
  <div class="rightlistBox">
      ...
      <div class="r1-body">
        ...
        <div class="catch-me">
          ...
          <div class="">
            ...
            <el-tooltip class="item" effect="dark" content="官号B站" placement="top">
              <a :href="catchMeObj.bilibili2" target="_blank"><i class="fa fa-fw fa-bold"></i></a>
            </el-tooltip>
          </div>
        </div>
      </div>
    ...
    <div v-if="this.$store.state.themeObj.user_start != 0"
      :class="gotoTop ? 'toTop hidden' : 'toTop goTop hidden'" @click="toTopfun">
      <img :src="
...
export default {
  data() {
    ...
    return {
      ...
      catchMeObj: {
        //个人信息
        git: "https://gitee.com/ancient-well-and-dry-pond",
        qq: "/static/img/qq.png",
        sina: "https://weibo.com",
        wechat: "/static/img/qq.jpg",
        csdn: "https://blog.csdn.net/yjj1123456",
        job: "https://www.baidu.com",
        bilibili1: "https://space.bilibili.com/546943464",
        bilibili2: "https://space.bilibili.com/525328268",
      },
    };
  },
  methods: {
